...
<title>NextRole Job Portal</title>
<link
...
<link rel="stylesheet" type="text/css" href="style1.css">
	<style>
		...
		.bg-clr {
			background-color: #f8f9fa; /* A lighter shade for a fresh look */
		}
		...
		.navbar-brand {
			color: #333; /* Darker text color for contrast */
			font-size: 2rem; /* Bigger size for brand logo */
		}
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-clr">
		<div class="container">
			<a class="navbar-brand fs-1 fw-medium " href="#">NextRole - Find Your Next Role!</a>
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item"><a class="nav-link"
						href="https://srinivas-kalagotla.netlify.app/">Contact</a></li>
				</ul>
			</div>
		</div>
	</nav>
